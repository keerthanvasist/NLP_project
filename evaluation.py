...
methods = ["try1_tfidf","try2_textrank","try3_title","try4_kmeans"]
for method in methods:
	...
	rouge_score = 0
	for key in system_topicwise_summaries:
		rouge_score += rouge.run_evaluation(human_topicwise_summaries[key], system_topicwise_summaries[key])
	print rouge_score/len(system_topicwise_summaries)